...
void StakeMiner(CWallet *pwallet)
{
    ...
    RenameThread("iloveyoucoins-stakeminer");
...
void static ILoveYouCoinsMiner(CWallet *pwallet)
{
    printf("ILoveYouCoinsMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("iloveyoucoins-miner");
    ...
    try { while (true) {
        ...
        {
            printf("ILoveYouCoinsMiner : no more PoW blocks\n");
            return;
        }

        IncrementExtraNonce(pblock, pindexPrev, nExtraNonce);

        printf("Running ILoveYouCoinsMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ILoveYouCoinsMiner terminated\n");
        throw;
    }
}

void GenerateILoveYouCoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&ILoveYouCoinsMiner, pwallet));
}
