...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("iloveyoucoins-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ILoveYouCoins " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"iloveyoucoins.com", "seed.iloveyoucoins.com"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ILoveYouCoins is probably already running."), addrBind.ToString().c_str());
        else
